...
if isnumeric(params)
    ...
    comma_loc       = strfind(params,',');
    Nassigned		 = 0;
    
    %First, locate any sub-parameter vectors
    bracket_loc1	= strfind(params,'[');
    bracket_loc2	= strfind(params,']');
...
%             val         = params(open_loc:close_loc);
        ...
        for i = 1:length(bracket_loc1)
            bracket_loc1	= strfind(params,'['); bracket_loc1 = bracket_loc1(1);
            bracket_loc2	= strfind(params,']'); bracket_loc2 = bracket_loc2(1);
